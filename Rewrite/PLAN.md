...
- [ ] T002 — Port Identity & role model
- [ ] T003 — Institutions, Specialities, SubSpecialities

### Phase 1 — Core domain

- [ ] T004 — EPAs, Curricula, assessment forms *(note: `AssessmentForm` from T004 stays as the scale/rubric building block; specific instruments move to activity types in Phase 3)*
